...
$pro_id=$_GET['proid'];
// echo $pro_id;die;
$getres =GetUpadePortfolio($pro_id);
// echo '<pre>';
// print_r($getres);die;
if(!empty($_GET['proid'])){
    $pro_id=$_GET['proid'];
    ...
    if(isset($_POST['desc'])){
      ...
      //   echo $_POST['newid'];die;
        $upid =$_POST['newid'];
        move_uploaded_file($tmp,"upload/".$filename);
      
        $result= UpdatePro($desc , $filename , $upid);
        // echo '<pre>';
        // print_r($_POST);die;
                ...
                <form action="updateportfolio.php" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <textarea class="form-control"  name="desc" id="summernote"><?= $getres['description']; ?></textarea>
                        </div>
                        <img src="upload/<?= $getres['img']; ?>" alt="img">
                        <div class="form-group">
                        ...
                        <div class="form-check">
                            <!-- hidden input for id -->
                            <input type="hidden" name="newid" value="<?= $pro_id?>" >
