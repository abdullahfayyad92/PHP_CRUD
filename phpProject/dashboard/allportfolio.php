    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                  <?php foreach($data as $ke): ?>  
                  <tr>
                    <td><?php echo $ke['description']; ?></td>
                    <td><?php echo $ke['name']; ?></td>
                    <td><img src="upload/<?php echo $ke['img']; ?>" alt="img"></td>
                    <td><a href="updateportfolio.php?proid=<?= $ke['id']; ?>" class="btn btn-secondary">update</a></td>
                    <td><a href="deleteportfolio.php?proid=<?= $ke['id']; ?>" class="btn btn-danger">delete</a></td>
                  </tr>
                  <?php endforeach;  ?>
                  <tfoot>
                  <tr>
